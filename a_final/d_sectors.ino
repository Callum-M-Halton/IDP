...
struct approachables_struct {
  ...
  const int red_junct; // const int red_box;
  const int green_junct; // const int green_box;
  const int home_junct; // const int home_box;
  ...
  const int ramp; const int block_to_left;
  const int block_straight;
};
